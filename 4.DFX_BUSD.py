...
Get_LP_tokens = driver.find_element_by_css_selector('.description>.custom_button.green').click()
modal_Ok = driver.find_element_by_css_selector('.mat-focus-indicator.mat-raised-button.mat-button-base.mat-primary').click()
close = driver.find_element_by_css_selector('.mat-focus-indicator.mat-button.mat-button-base').click()
